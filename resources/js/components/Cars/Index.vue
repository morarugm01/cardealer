            ...
            <table class="min-w-full divide-y divide-gray-200 border">
                ...
                <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">Lorem ipsum dolor sit
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">2022-01-01 13:43:47
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">Lorem ipsum dolor sit
                            ...
                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
                            proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</td>
                        <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">2022-01-02 14:43:47
                        </td>
                    </tr>
                </tbody>
            </table>
